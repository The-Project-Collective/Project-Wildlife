package com.collective.projectwildlife.screens.machines;
...
public class FeederScreen extends HandledScreen<FeederScreenHandler> {
    ...
    private static final Identifier TEXTURE = Identifier.of(ProjectWildlife.MOD_ID, "textures/gui/feeder.png");
