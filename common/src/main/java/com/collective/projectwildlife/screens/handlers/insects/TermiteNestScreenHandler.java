...
public class TermiteNestScreenHandler extends CoreBaseScreenHandler {

    private final Inventory inventory;

    public TermiteNestScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(1));
    }

    public TermiteNestScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(WildlifeScreenHandlers.TERMITE_NEST_SCREEN_HANDLER.get(), syncId);
