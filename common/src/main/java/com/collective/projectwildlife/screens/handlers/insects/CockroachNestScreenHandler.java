...
public class CockroachNestScreenHandler extends CoreBaseScreenHandler {

    private final Inventory inventory;

    public CockroachNestScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(1));
    }

    public CockroachNestScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(WildlifeScreenHandlers.COCKROACH_NEST_SCREEN_HANDLER.get(), syncId);
