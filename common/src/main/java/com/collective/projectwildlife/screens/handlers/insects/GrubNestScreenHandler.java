...
public class GrubNestScreenHandler extends CoreBaseScreenHandler {

    private final Inventory inventory;

    public GrubNestScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(1));
    }

    public GrubNestScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(WildlifeScreenHandlers.GRUB_NEST_SCREEN_HANDLER.get(), syncId);
