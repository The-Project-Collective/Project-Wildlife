...
public class MoleCricketNestScreenHandler extends CoreBaseScreenHandler {

    private final Inventory inventory;

    public MoleCricketNestScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(1));
    }

    public MoleCricketNestScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(WildlifeScreenHandlers.MOLE_CRICKET_NEST_SCREEN_HANDLER.get(), syncId);
